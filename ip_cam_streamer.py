...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--port', type=int, default=5000, help='Port number of the app')
    parser.add_argument('-c', '--cam_ip', type=str, help='(HTTP) IP address of the IP camera with port', required=True)
